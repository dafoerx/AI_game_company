...
从现在开始，3 个角色统一执行下面的节奏：

1. 开始工作后，若连续执行超过 **10 分钟** 且还未交付最终结果，必须更新一次进度
2. 进度优先写回 **当前活跃任务卡**，不为普通同步额外新建长文档
3. 进度更新只保留最小字段：**当前时间 / 已完成 / 进行中 / 下一步或阻塞**
4. 如果本轮工作在 10 分钟内结束，可直接写最终结论，不强制额外补报
...
- 如果任务超过 30 分钟仍无阶段性结果，至少应累计写回 3 次进度，避免执行黑箱化
